...
*  Zweck: ￿ersichtsliste ￿ie Kurse mit Filter- und Sortierfunktion
*/
...
$sql_course_select = "select 
		...
		and 
			a.products_id=b.id
		and
			a.timeperiods_id=c.id and c.camp='0'
		and
...
<? if ($pagesize==100000)
{ ?>
    	<a href="kurs_list.php?pagesize=50&field=<?echo $field?>">geteilt anzeigen</a>
<?} else { ?>
	    <a href="kurs_list.php?pagesize=100000&field=<?echo $field?>">alle anzeigen</a>
<?}
?>
	</td></tr>
</table>
...
echo "<a target='_blank' href='kurs_form.php' ONMOUSEOVER=\"window.status='Neuer Eintrag'; return true;\" ONMOUSEOUT=\"window.status='';return true\"><img src='../images/buttons/neuereintrag.gif' border=no></a><br><br>";
...
$links[0]->url = "../admin/kurs_form.php?id=";
$links[0]->column = "Kurs";
$links[0]->param = "";
