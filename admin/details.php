...
<body>
<font size=+1>Allgemeine und zusätzliche Infos:</font><br><br>
<div align=left>
<?
...
<tr class="form_header" align=center>
	...
	<td class="headline_s"> &nbsp;Stundeninhalt &nbsp;</td>
	<td class="headline_s"> &nbsp;Bemerkungen &nbsp;</td>
	<td class="headline_s"> &nbsp;Verwendete Geräte &nbsp;</td>
	<td class="headline_s" colspan=5> &nbsp;Kursleiter &nbsp;</td>
</tr>
<?
$sql_content_select="select id,date,content,remarks,used_items,checked from coursetimes where courses_id=$kurs order by date asc";
...
while(list($ctid,$date,$hourcontent,$remarks,$used_items)= $rs_content_select -> fetch_row())
{
	$d = explode("-",$date);
	$date=$d[2].".".$d[1].".".$d[0];
	print("<tr><td>$date</td><td>$hourcontent</td><td>$remarks</td><td>$used_items</td>");
...
<br><br>
<font size=+1>Austragungsort des Kurses:</font><br><br>
<table border=1>
<tr>
	<td class="form_header"> &nbsp;Name &nbsp;</td>
	<td> &nbsp;<?print($loc_name)?> &nbsp;</td>
</tr>
<tr>
	<td class="form_header"> &nbsp;Adresse &nbsp;</td>
	<td> &nbsp;<?print($loc_address)?> &nbsp;</td>
</tr>
<tr>
	<td class="form_header"> &nbsp;Ort &nbsp;</td>
	<td> &nbsp;<?echo $loc_city.", ".$zip?> &nbsp;</td>
</tr>
<tr>
	<td class="form_header"> &nbsp;Kontaktperson &nbsp;</td>
	<td> &nbsp;<?print($loc_kontakt)?> &nbsp;</td>
</tr>
<tr>
	<td class="form_header"> &nbsp;Telefon &nbsp;</td>
	<td> &nbsp;<?print($loc_tel1)?> &nbsp;</td>
</tr>
<tr>
	<td class="form_header"> &nbsp;Telefon &nbsp;</td>
	<td> &nbsp;<?print($loc_tel2)?> &nbsp;</td>
</tr>
<tr>
	<td class="form_header"> &nbsp;Bemerkungen &nbsp;</td>
	<td> &nbsp;<?print($loc_remarks)?> &nbsp;</td>
</tr>
</table>
<br><br>
<font size=+1>Kunde:</font><br>
<br>
<table border=1>
<tr>
	<td class="form_header"> &nbsp;Name &nbsp;</td>
	<td> &nbsp;<?print($school_name)?> &nbsp;</td>
</tr>
<tr>
	<td class="form_header"> &nbsp;Adresse &nbsp;</td>
	<td> &nbsp;<?print($school_address)?> &nbsp;</td>
</tr>
<tr>
	<td class="form_header"> &nbsp;Ort &nbsp;</td>
	<td> &nbsp;<?echo $school_city.", ".$zip?> &nbsp;</td>
</tr>
<tr>
	<td class="form_header"> &nbsp;Kontaktperson &nbsp;</td>
	<td> &nbsp;<?print($school_kontakt)?> &nbsp;</td>
</tr>
<tr>
	<td class="form_header"> &nbsp;Telefon &nbsp;</td>
	<td> &nbsp;<?print($school_tel1)?> &nbsp;</td>
</tr>
<tr>
	<td class="form_header"> &nbsp;Telefon &nbsp;</td>
	<td> &nbsp;<?print($school_tel2)?> &nbsp;</td>
</tr>
<tr>
	<td class="form_header"> &nbsp;Bemerkungen &nbsp;</td>
	<td> &nbsp;<?print($school_remarks)?> &nbsp;</td>
</tr>
</table>
</div>
</body>
